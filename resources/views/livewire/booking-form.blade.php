<div class="mb-6 w-full px-6">
    ...
    <form wire:submit.prevent="second()" action="" @class(['flex flex-col items-center', 'hidden' => $currentStep != 2]) style="height:50vh;">
        ...
        <div class="mb-4 w-full">
            ...
            <input type="text" wire:model="questions.{{$qus}}" id="{{$qus}}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" required>
        </div> 
