<div>
    ...
    <div id="accordion-collapse-body-1" class="" aria-labelledby="accordion-collapse-heading-1">
          <div class="p-5 font-light border border-b mb-6 border-gray-200 dark:border-gray-700 dark:bg-gray-900">
              <form wire:submit.prevent="create_event" action="" method="POST">
                @csrf
                  <div class="mb-6 sm:w-1/2 w-full">
                      ...
                      <input type="text" id="eventname" wire:model="eventname" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                  </div> 
                  <label id="assigned-to-label" class="block mb-2 text-base font-medium text-gray-900 dark:text-gray-300">Location </label>
                  <div class="mb-6 sm:w-1/2 w-full" x-data="{ open: false }">
                      ...
                      <div class="mt-4" x-show="open" x-transition.300ms>
                          <input type="text" id="location" wire:model="location" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="enter address">
                      </div>
                  </div>
                  <div class="mb-6 sm:w-1/2 w-full">
                      <label for="description" class="block mb-2 text-base font-medium text-gray-900 dark:text-gray-400">Description</label>
                      <textarea id="description" wire:model="description" rows="6" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-sm border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Your message..."></textarea>
                  </div>
                  <div class="mb-6 sm:w-1/2 w-full">
                      <label for="eventlink" class="block mb-2 text-base font-medium text-gray-900 dark:text-gray-400">Event Link *</label>
                      <input type="test" wire:model="app_name_slug" id="eventlink" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" readonly>
                      <!-- Trigger -->
