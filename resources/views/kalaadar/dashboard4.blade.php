                ...
                <div class="p-6 w-full sm:max-w-md h-44 mt-16 bg-white  ">
                    <div>
                        ...
                        <form>
                            ...
                            <button data-modal-toggle="popup-modal" type="button" class="flex mb-4 items-center text-white bg-blue-400 dark:bg-blue-500  font-medium rounded-lg text-sm px-3 py-1.5 text-center">
                            ...
                            <div class="flex justify-end items-center pb-8">
                                ...
                                <button data-modal-toggle="small-modal" type="button" class="flex items-center text-white bg-blue-600 dark:bg-blue-700 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Done</button>
                            </div>
                                ...
                                <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        ...
                                        <div class="p-6">
                                            ...
                                            <div class="flex px-2 w-1/2 py-1 mb-6 text-sm text-blue-700 bg-blue-100 rounded-lg dark:bg-blue-200 dark:text-blue-800" role="alert">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v12m6-6H6" />
                                                  </svg>
                                ...
                                <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                                    ...
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        ...
                                        <div class="p-6 space-y-6">
                                            ...
                                            <p class="text-sm flex items-center justify-between leading-relaxed text-blue-600 dark:text-blue-500">
                                                https://kalaadar.com/israel-adegbulugbe 
                                                <button class="p-2 hover:scale-110 rounded-full hover:bg-blue-300 transition ease-in-out duration-500" data-tooltip-target="tooltip-animation">
