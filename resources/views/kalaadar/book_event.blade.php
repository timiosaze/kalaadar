<x-guest-layout>
<div class="my-auto px-2 sm:px-0 md:px-16">
    <div class="max-w-5xl flex mx-auto overflow-auto flex-col sm:flex-row items-center mt-20 sm:border sm:border-gray-200 shadow-lg">
            <div class="w-96 bg-white sm:border-r px-4 sm:px-8 sm:py-28 sm:border-gray-200">
                <div class="flex flex-col sm:items-start  items-center pb-10 w-full">
                    <img class="mb-2 mt-6 w-24 h-24 rounded-full shadow-lg" src="{{asset('images/avatar2.png')}}" alt="Bonnie image">
                    {{-- {{dd($event)}} --}}
                    <span class="mb-2 text-sm text-gray-500 dark:text-gray-400">{{$event[0]->user->name}}</span>
                    <h5 class="mb-2 text-xl font-medium text-gray-900 dark:text-white">{{$event[0]->eventname}}</h5>
                    <p class="flex flex-row items-center text-sm font-medium text-gray-500">
                        {{-- <div class="mr-3"> --}}
                    ...
                    <p class="mb-2 flex flex-row items-center text-sm font-medium text-gray-500">
                        ...
                        {{-- </div> --}}
                       {{$event[0]->bookingevent->duration . 'mins'}}
                    </p>
                </div>
            </div>
            <livewire:booking-form :event="$event"/>
    </div>
</div>
</x-guest-layout>