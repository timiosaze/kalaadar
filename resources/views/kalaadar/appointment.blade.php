<x-guest-layout>
    <div class="flex relative" x-data="{open: false}">
        <aside class="w-64 h-full fixed z-10 hidden sm:relative sm:block" id="aside"  aria-label="Sidebar">
            <div class="overflow-y-auto py-4 px-3 h-screen bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700">
                <div class="flex items-center pl-2 mb-5">
                    <img src="{{asset('images/kalaadar-logo.png')}}" class="mr-3 h-6 sm:h-8" alt="Kalaadar Logo" />
                    <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Kalaadar</span>
                    <button class="ml-auto hover:text-primary-600 sm:hidden" id="close-aside">
        ...
        <div class="flex flex-col grow flex-1 ">
            <div class="flex items-center border-b border-gray-200 px-4 py-3">
                ...
                <button class="rounded-full ml-3 hover:bg-primary-300 p-1.5 transition duration-300 linear md:hidden" id="bars-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6.75h16.5M3.75 12H12m-8.25 5.25h16.5" />
                    </svg>
                </button>
            </div>
            <div class="w-full h-full flex items-start justify-center px-1 sm:px-0">
                <div class="p-6 w-full sm:max-w-md h-44 my-8 bg-white">
                    <div>
