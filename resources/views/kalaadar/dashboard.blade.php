    ...
    <div class="flex relative" x-data="{open: false}">
        ...
        <div class="flex flex-col grow flex-1">
            ...
            <div class="w-full h-full flex items-center justify-center px-4 sm:px-0">
                <div class="p-6 sm:max-w-md bg-white  ">
                    <div class="flex items-center justify-center my-4">
                        <img class="w-44 h-44 rounded-full" src="{{asset('test.jpeg')}}" alt="logo">
                    </div>
                    <a href="#">
                        <h5 class="mb-2 text-lg font-semibold tracking-tight text-gray-900 dark:text-white text-center">Start by creating your first appointment</h5>
                    </a>
                    ...
                    <div class="flex items-center justify-center">
                        <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-md text-xs px-3 py-2 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
